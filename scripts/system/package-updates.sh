...
# Description: Checks for available package updates using check_all_updates
# Author: saatvik333
# Version: 2.0
# Dependencies: check_all_updates, notify-send
#===============================================================================
...
get_update_count() {
	local updates
	if ! updates=$(check_all_updates 2>/dev/null | wc -l); then
